...
import com.github.backend.dto.Post.AwsS3;
...
public class S3UploadService {
    ...
    private String randomFileName(File file, String dirName) {
        return dirName + "/" + UUID.randomUUID() +"." +extractExt(file.getName());
    }
    ...
    public void remove(String imageKey) {
        if (!amazonS3.doesObjectExist(bucket,imageKey)) {
            throw new AmazonS3Exception("Object " +imageKey+ " does not exist!");
        }
